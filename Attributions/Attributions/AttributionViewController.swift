...
open class AttributionViewController: UITableViewController {
    ...
    public func setAttributions(from sections: [AttributionSection]) throws {
        attributionSections = sections
        attributions = try AttributionReader().compileAttributions(sections: attributionSections)
    }
    ...
    open override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.navigationController?.pushViewController(licenseController, animated: true)
    }
